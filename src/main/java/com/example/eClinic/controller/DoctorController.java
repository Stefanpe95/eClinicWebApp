...
public class DoctorController {
	...
	private IDoctorService doctorService;
	  ...
	  public ResponseEntity<List<Doctor>> getAllDoctors() {
			...
			if(list.isEmpty()) return new ResponseEntity<List<Doctor>>(list, HttpStatus.NOT_FOUND);
		...
		public ResponseEntity<Doctor> getDoctorbyId(@PathVariable("id") Integer id) {
			...
			if(doctor.isEmpty()) return new ResponseEntity<Doctor>(doctor.get(), HttpStatus.NOT_FOUND);
			else return new ResponseEntity<Doctor>(doctor.get(), HttpStatus.OK);
		}
		...
		public ResponseEntity<Doctor> deleteDoctor(@PathVariable("id") Integer id) {
	  		...
	  		if(obj.isEmpty()) return new ResponseEntity<Doctor>(obj.get(),HttpStatus.NOT_FOUND);
	  		else {doctorService.deleteDoctor(id);
